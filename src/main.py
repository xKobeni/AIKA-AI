def _print_help():
    print(
        ...
        "\n  list skills         Show installed local skills"
        "\n  show skill <id>     Show skill requirements and status"
        "\n  use skill <id>      Activate a skill for this session"
        "\n  deactivate skill    Deactivate the current skill"
        "\n  reload skills       Reload and validate local skills"
